        ...
        result.andExpect(status().isOk())
                .andDo(document("search_whole_map",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("result.data.content[].userInfo[].id").optional().type(NUMBER).description("유저 id (큐레이터 지도 검색)"),
                                fieldWithPath("result.data.content[].userInfo[].userName").optional().type(NUMBER).description("유저 이름 (큐레이터 지도 검색)"),
                                fieldWithPath("result.data.content[].userInfo[].userIconImgUrl").optional().type(NUMBER).description("유저 아이콘 url (큐레이터 지도 검색)"),
